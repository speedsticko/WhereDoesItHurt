 ...
 */
   ...
   private int mSavedBackground = Color.GREEN; //R.color.drop_target_color1;
 ...
 * The drag has eneded
 */
public void onDragEnd(View v, int top, int left) 
{
    toast ("onDragEnd");
}
...
{
    toast ("onDragEnter");
    int bg = isEnabled () ? Color.BLUE : Color.GRAY; //R.color.drop_target_enabled : R.color.drop_target_disabled;
